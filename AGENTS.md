...
- The item and selected-item tables use independent optional-column checkboxes; the 添加数量 (quantity) column starts shown, the other optional columns start hidden.
